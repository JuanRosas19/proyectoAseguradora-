...
const textoNosotros = {
  ...
  descripcion:
    'Convencidos de las grandes oportunidades de negocios que existen en nuestro país. Estamos comprometidos con el cumplimiento de nuestros principios éticos y organizacionales, y confiamos plenamente en el potencial que nos ofrece esta tierra de gracia, para seguir creando valor en beneficio de la comunidad y de todos los que forman parte de la familia de Seguros H&H',
  ...
  informacion: [
    ...
    },
    {
      ...
      texto:
        'Nos destacamos por nuestro precios, inigualables en el mercado y con una calidad insuperable.',
    },
    {
      icono: 'fas fa-users',
      texto:
...
const textosBenficiosInfo = {
  ...
  parrafo:
    'Con Seguros H&H podras tener el respaldo y la confianza de que tus bienes se encuentran con el mejor aliado cuando de seguridad se trata.',
};
const titulos = {
...
const accionInformacion = {
  ...
  subtitulo:
    'Forma parte de nuestra familia, cada día más personas forman parte de nosotros y confian en nuestros servicios. Si eres un cliente nuevo de Seguros H&H, te invitamos a que te nos contactes y te ayudemos a encontrar la mejor alternativa a tus necesidades.',
  tituloBoton: '¡Contáctanos!',
  path: '/contacto',
  iconoBoton: 'fas fa-paper-plane',
};
const suscripcionInformacion = {
  titulo: '¡Suscribete y recibe las mejores ofertas',
...
const informacionEquipo = {
  ...
  texto:
    'Conoce a nuestros fundadores y sus respectivas carreras. Cada uno de ellos ha sido uno de los protagonistas de nuestra se Seguros H&H.',
};
...
const planesInformacion = [
  ...
  },
  {
    ...
    informacion: [
      {
        titulo: 'Todos los servicios de la versión basica',
        servicioDisponible: true,
      },
      {
      ...
      {
        titulo: 'Centa con respaldo de salud las 24HRS',
        servicioDisponible: true,
      },
      {
...
const preguntas = [
  {
    ...
    respuesta:"Seguros H&H es una  es una compañía de capital 100% venezolano, conformada por un grupo de accionistas de dilatada y sólida experiencia en el mercado asegurador. Nuestra misión es ofrecer a nuestros clientes una amplia gama de productos y servicios de seguros, con precios accesibles y con coberturas de excelente calidad.",
  },
  {
